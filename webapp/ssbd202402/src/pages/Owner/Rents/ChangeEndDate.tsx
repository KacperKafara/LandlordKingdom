                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value ? (
                            format(field.value, "PPP", {locale: language === "pl" ? pl : enUS})
                          ) : (
                    ...
                    <PopoverContent className="w-auto p-0"  align="end">
                      <Calendar
                        ...
                        disabled={(date) =>
                            date.getDay() !== 0 || date <= new Date(startDate) || date < new Date() || date.setHours(0,0,0,0) === new Date(endDate).setHours(0,0,0,0)
                        }
                        initialFocus
                        weekStartsOn={1}
                      />
