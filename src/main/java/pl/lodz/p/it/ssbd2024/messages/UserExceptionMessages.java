...
public class UserExceptionMessages {
    ...
    public final static String ALREADY_BLOCKED = "User is already blocked";
    public final static String ALREADY_UNBLOCKED = "User is already unblocked";
    public final static String ACCESS_LEVEL_REMOVED = "Access level already removed from user";
