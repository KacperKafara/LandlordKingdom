...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Override
    public String verifyOTP(String token, String login, String ip) throws VerificationTokenUsedException, VerificationTokenExpiredException, NotFoundException, LoginNotMatchToOTPException {
